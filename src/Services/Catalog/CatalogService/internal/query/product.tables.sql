CREATE TABLE products (
    ...
    sold_quantity INT DEFAULT 0 CHECK (sold_quantity >= 0), /* Số lượng bán phải >= 0 */
    average_rating FLOAT DEFAULT 0 CHECK (average_rating >= 0), /* Đánh giá trung bình phải >= 0 */
    quantity_evaluate INT DEFAULT 0 CHECK (quantity_evaluate >= 0), /* Số lượng đánh giá phải >= 0 */
    discount_percentage INT DEFAULT 0 CHECK (discount_percentage >= 0), /* Mã giảm giá riêng phải >= 0 */
